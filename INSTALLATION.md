...
`MediaWiki Dump Generator` requires [Python 3.13](https://www.python.org/downloads/latest/python3.13/) or later (less than 4.0), but you may be able to get it run with earlier versions of Python 3. On recent versions of Linux and macOS Python 3.13 should come preinstalled, but on Windows you will need to install it from [python.org](https://www.python.org/downloads/latest/python3.13/).
